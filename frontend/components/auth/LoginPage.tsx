    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-[#FFF7EA]">
            <div className="w-full max-w-md rounded-3xl border border-[#FFEDC1] bg-white p-8 shadow-xl">
                <div className="mb-8">
                    <p className="text-xs font-bold uppercase tracking-[0.25em] text-[#8A5A5A]">IntelliML Access</p>
                    <h1 className="mt-2 text-4xl font-display font-bold text-[#470102]">Sign In</h1>
                    <p className="mt-2 text-sm text-[#8A5A5A]">Welcome back. Continue your analysis workflow.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="mb-1 block text-xs font-bold uppercase tracking-wider text-[#8A5A5A]">Username</label>
                        <input
                            type="text"
                            value={username}
                    ...
                    <div>
                        <label className="mb-1 block text-xs font-bold uppercase tracking-wider text-[#8A5A5A]">Password</label>
                        <input
                            type="password"
                            value={password}
