 ...
 * Centralized icon library for the entire frontend.
 */
...
export const SpinnerIcon = ({ className = "w-5 h-5 animate-spin" }: { className?: string }) => (
...
export const WrenchIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// --- Data Operation Icons (used in DataCleaning, FileUploader, ModelTraining) ---
